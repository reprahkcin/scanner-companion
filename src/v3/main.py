...
class ScannerGUI(tk.Tk):
    ...
    def motor1_ccw(self):
        ...
        try:
            ...
            self.status_var.set(f"Motor 1: CCW {step}° (total: {self.motor1_position_deg:.1f}°)")
    ...
    def motor1_cw(self):
        ...
        try:
            ...
            self.motor1_position_deg += step
            self.motor1_pos_var.set(f"{self.motor1_position_deg:.1f}°")
            self.status_var.set(f"Motor 1: CW {step}° (total: {self.motor1_position_deg:.1f}°)")
            # TODO: Send serial command to Arduino
        except ValueError:
            self.status_var.set("Invalid step size for Motor 1")
    ...
    def motor1_home(self):
        ...
        self.status_var.set("Motor 1: Homing to 0°")
        # TODO: Send serial command to Arduino
    ...
    def motor1_goto(self):
        ...
        try:
            ...
            self.motor1_pos_var.set(f"{self.motor1_position_deg:.1f}°")
            self.status_var.set(f"Motor 1: Moving to {target}°")
            # TODO: Send serial command to Arduino
        except ValueError:
    ...
    def motor2_up(self):
        ...
        try:
            ...
            self.status_var.set(f"Motor 2: Up {step}mm (total: {self.motor2_position_mm:.1f}mm)")
            # TODO: Send serial command to Arduino
        except ValueError:
    ...
    def motor2_down(self):
        ...
        try:
            ...
            self.motor2_position_mm -= step
            self.motor2_pos_var.set(f"{self.motor2_position_mm:.1f}mm")
            self.status_var.set(f"Motor 2: Down {step}mm (total: {self.motor2_position_mm:.1f}mm)")
            # TODO: Send serial command to Arduino
        except ValueError:
            self.status_var.set("Invalid step size for Motor 2")
    ...
    def motor2_home(self):
        ...
        self.status_var.set("Motor 2: Homing to 0mm")
        # TODO: Send serial command to Arduino
    ...
    def motor2_goto(self):
        ...
        try:
            ...
            self.motor2_pos_var.set(f"{self.motor2_position_mm:.1f}mm")
            self.status_var.set(f"Motor 2: Moving to {target}mm")
            # TODO: Send serial command to Arduino
        except ValueError:
